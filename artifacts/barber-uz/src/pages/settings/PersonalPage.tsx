...
// ServiceForm is imported from @/components/ServiceForm
          ...
          <AnimatePresence mode="wait">
            ...
            {step === "verifying" && (
              <motion.div key="verifying" initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-10">
                ...
                {sessionId && (
                  <button onClick={() => { window.location.href = `tg://resolve?domain=Barberuz_yordamchi_bot&start=booking_${sessionId}`; }}
  ...
  return (
    <div className="pb-28 -mx-4">
        ...
        <div className="w-full h-44 relative overflow-hidden">
          {coverImage
            ...
            : <div className="w-full h-full bg-zinc-950">
                <div className={`absolute inset-0 bg-gradient-to-br ${COVER_GRAD[gradIdx]} opacity-60`} />
              </div>
          }
      ...
      <div className="px-4 pt-3 pb-3">
        <h1 className="text-2xl font-display font-bold text-foreground mb-0.5">{profile.brandName || profile.name}</h1>
